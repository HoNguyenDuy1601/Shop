...
namespace Shop.Controllers
{
    public class ProductTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type")] ProductTypes productTypes)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type")] ProductTypes productTypes)
        {
